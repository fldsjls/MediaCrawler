...
const DATA_DIR = "storage/meishiwang";
...
export const meishiwangSettings = {
    ...
    headless: false,
    loadStorage: "storage/meishiwang/auth/storage_state/login.json",
    manualLogin: true,
    maxLessons: undefined as number | undefined,
    output: "storage/meishiwang/export/meishiwang-m3u8-results.json",
    processedOutput: "storage/meishiwang/processed/meishiwang-m3u8-results.json",
    rawOutput: "storage/meishiwang/raw/meishiwang-m3u8-results.json",
    saveStorage: "storage/meishiwang/auth/storage_state/login.json",
    startLesson: 1,
    url: "http://edu.meishiwang100.com/course/package/4696",
    userDataDir: "storage/meishiwang/auth/persistent_context/edge-profile",
    waitMs: 5000,
    download: {
        ...
        outputDir: "storage/meishiwang/downloads",
        rename: {
