...
# -*- coding: utf-8 -*-
from mediacrawler.paths import BROWSER_ROOT
from mediacrawler.paths import javascript
import asyncio
import os
...
from mediacrawler.platforms.constants import zhihu as constant
from mediacrawler.common.base.base_crawler import AbstractCrawler
from mediacrawler.platforms.models.m_zhihu import ZhihuContent, ZhihuCreator
from mediacrawler.infrastructure.proxy.proxy_ip_pool import IpInfoModel, create_ip_pool
from mediacrawler.storage.stores import zhihu as zhihu_store
...
from mediacrawler.common.context import crawler_type_var, source_keyword_var
    ...
    async def start(self) -> None:
        ...
        async with async_playwright() as playwright:
            ...
            if config.ENABLE_CDP_MODE:
                ...
                await self.browser_context.add_init_script(path=javascript('stealth.min.js'))
    ...
    async def launch_browser(
        ...
        if config.SAVE_LOGIN_STATE:
            ...
            user_data_dir = os.path.join(
                str(BROWSER_ROOT), config.USER_DATA_DIR % config.PLATFORM
            )  # type: ignore
