...
from mediacrawler.platforms.models.m_douyin import VideoUrlInfo, CreatorUrlInfo
from mediacrawler.infrastructure.helpers.crawler_util import extract_url_params_to_dict

douyin_sign_obj = execjs.compile(open(javascript('douyin.js'), encoding='utf-8-sig').read())
