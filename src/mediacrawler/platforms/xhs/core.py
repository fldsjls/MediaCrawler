...
from mediacrawler.platforms.models.m_xiaohongshu import NoteUrlInfo, CreatorUrlInfo
from mediacrawler.infrastructure.proxy.proxy_ip_pool import IpInfoModel, create_ip_pool
from mediacrawler.storage.stores import xhs as xhs_store
...
class XiaoHongShuCrawler(AbstractCrawler):
    ...
    async def launch_browser(
        ...
        if config.SAVE_LOGIN_STATE:
            ...
            user_data_dir = os.path.join(str(BROWSER_ROOT), config.USER_DATA_DIR % config.PLATFORM)  # type: ignore
