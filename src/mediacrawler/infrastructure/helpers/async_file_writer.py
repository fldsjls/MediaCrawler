...
from mediacrawler.paths import DATA_ROOT
import asyncio
import csv
import json
import os
...
from mediacrawler.infrastructure.helpers.utils import utils
from mediacrawler.infrastructure.helpers.words import AsyncWordCloudGenerator
...
class AsyncFileWriter:
    ...
    def _get_file_path(self, file_type: str, item_type: str) -> str:
        if config.SAVE_DATA_PATH:
            ...
            base_path = str(DATA_ROOT / self.platform / file_type)
    ...
    async def generate_wordcloud_from_comments(self):
        ...
        try:
            ...
            if config.SAVE_DATA_PATH:
                ...
                words_base_path = str(DATA_ROOT / self.platform / "words")
