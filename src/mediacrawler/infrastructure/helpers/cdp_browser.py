...
from mediacrawler.infrastructure.helpers.browser_launcher import BrowserLauncher
...
class CDPBrowserManager:
    ...
    async def add_stealth_script(self, script_path: str = javascript('stealth.min.js')):
        """
