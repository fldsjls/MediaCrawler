...
"""
from mediacrawler.paths import PROJECT_ROOT, WEBUI_ROOT
import asyncio
import os
import sys
import subprocess
...
from mediacrawler.workbench.router import router as workbench_router, startup, shutdown, allowed
...
async def serve_frontend():
    ...
    return {
        ...
        "version": "1.0.0",
        "docs": "/docs",
        "note": "WebUI not found, please build it first: npm run build:web"
    }
        ...
        if sys.platform == "win32":
            ...
            process = await loop.run_in_executor(
                ...
                lambda: subprocess.run(
                    [sys.executable, "-m", "mediacrawler.cli.main", "--help"],
                    capture_output=True,
                    timeout=30.0,
