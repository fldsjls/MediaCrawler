...
import mediacrawler.cli.arguments as cmd_arg
import mediacrawler.config as config
from mediacrawler.storage.database import db
from mediacrawler.common.base.base_crawler import AbstractCrawler
from mediacrawler.platforms.bilibili import BilibiliCrawler
from mediacrawler.platforms.douyin import DouYinCrawler
from mediacrawler.platforms.kuaishou import KuaishouCrawler
from mediacrawler.platforms.tieba import TieBaCrawler
from mediacrawler.platforms.weibo import WeiboCrawler
from mediacrawler.platforms.xhs import XiaoHongShuCrawler
from mediacrawler.platforms.zhihu import ZhihuCrawler
from mediacrawler.infrastructure.helpers.async_file_writer import AsyncFileWriter
from mediacrawler.common.context import crawler_type_var
...
def entrypoint():
    from mediacrawler.infrastructure.helpers.app_runner import run
