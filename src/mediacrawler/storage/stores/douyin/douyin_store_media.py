...
from mediacrawler.common.base.base_crawler import AbstractStoreImage, AbstractStoreVideo
...
class DouYinImage(AbstractStoreImage):
    def __init__(self):
        if config.SAVE_DATA_PATH:
            ...
            self.image_store_path = str(DATA_ROOT / 'douyin/images')
...
class DouYinVideo(AbstractStoreVideo):
    def __init__(self):
        if config.SAVE_DATA_PATH:
            ...
            self.video_store_path = str(DATA_ROOT / 'douyin/videos')
