...
from mediacrawler.workbench.downloads.identity import canonical_url, resource_identity, logical_resource_identity
from mediacrawler.workbench.browser.preview.internal import is_internal_preview_url
...
def classify(url, content_type=''):
    ...
    if suffix in ('.pdf', '.epub', '.zip', '.docx', '.xlsx', '.csv', '.txt'):
...
class MediaCapture:
    ...
    def add(self, resource):
        ...
        value['logical_id'] = logical_resource_identity(value)
