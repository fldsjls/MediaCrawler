export const sections = [
  ...
  { dir: 'guides', text: '操作指南', pages: [['collection', '采集与下载'], ['platforms', '平台管理与 API'], ['browser', '浏览器交互'], ['settings', '设置中心'], ['results', '结果与重试'], ['cli/', 'CLI 参考']] },
  { dir: 'architecture', text: '架构', pages: [['overview', '系统总览'], ['repository-layout', '目录与路径'], ['layer-boundaries', '职责边界'], ['browser-workspace', '浏览器双模式'], ['settings', '设置职责'], ['upstream-cli', '上游 CLI 架构']] },
  ...
  { dir: 'adr', text: '决策记录', pages: [['0001-documentation-architecture', '0001 文档信息架构'], ['0002-browser-dual-mode', '0002 浏览器双模式'], ['0003-settings-navigation', '0003 设置层级'], ['0004-native-tab-capture', '0004 原生捕获身份'], ['0005-consolidated-repository', '0005 集中目录']] },
  { dir: 'about', text: '关于', pages: [['author', '上游作者'], ['learning', '学习资料'], ['pro', '上游 Pro 说明'], ['community', '社区'], ['supporters', '支持者'], ['providers/', '代理资料'], ['upstream/', '上游说明存档']] },
];
export const nav = [
