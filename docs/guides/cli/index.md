> 文档类型：上游 CLI 参考
> 范围：原首页的命令行说明。首次安装 Web 工作台请使用[本机环境](/getting-started/local-setup.md)。

# MediaCrawler使用方法

## 项目文档

- [项目架构文档](/architecture/upstream-cli.md) - 系统架构、模块设计、数据流向（含 Mermaid 图表）
...
python -m mediacrawler.cli.main --platform xhs --lt qrcode --type search --save_data_option sqlite
python -m mediacrawler.cli.main --platform xhs --lt qrcode --type search --save_data_option db
