...
from api.main import local_access
from api.routers import crawler as legacy_router
from api.services.crawler_manager import CrawlerManager
from api.workbench import router as workbench_router
from api.workbench.compat import LegacyTaskFacade
...
def test_passive_resource_channel_does_not_create_task_or_leak_credentials(local_api):
    from api.workbench.media.capture import MediaCapture
